...
from . import saka_bot, saka_cmd, check_filename, get_string


@saka_cmd(pattern="[qQ]rcode( (.*)|$)")
async def cd(e):
    ...
    elif saka_bot.me.photo and not saka_bot.me.photo.has_video:
        cimg = await e.client.get_profile_photos(saka_bot.uid, limit=1)[0]
