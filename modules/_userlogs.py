...
from Saka.dB.botchat_db import tag_add, who_tag
...
from . import (LOG_CHANNEL, LOGS, Button, asst, saka_bot, callback, events,
...
if udB.get_key("TAG_LOG"):
    ...
    @saka_bot.on(events.MessageEdited(func=lambda x: not x.out))
    ...
    async def idk(e):
        ...
        if chat and msg:
            try:
                await saka_bot.send_message(chat, e.message, reply_to=msg)
...
_client = {"bot": asst, "user": saka_bot}
