...
from . import saka_cmd


@saka_cmd(outgoing=True, pattern=r"^[nN][g][e][n][t][o][t]$")
async def _(event):
...
@saka_cmd(outgoing=True, pattern=r"^[gG][oO][bB][lL[oO][kK]$")
async def _(event):
...
@saka_cmd(outgoing=True, pattern=r"^[nN][g][a][t][a][i][n]$")
async def _(event):
...
@saka_cmd(outgoing=True, pattern=r"^[yY][a][t][i][m]$")
async def _(event):
...
@saka_cmd(outgoing=True, pattern=r"^[kK][nN][tT][lL]$")
async def _(event):
