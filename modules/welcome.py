...
from Saka.dB.greetings_db import (add_goodbye, add_welcome, delete_goodbye,
                                  delete_welcome, get_goodbye, get_welcome)
from Saka.fns.tools import create_tl_btn, format_btn, get_msg_button
...
@saka_cmd(pattern="[Ss][e][t][w][e][l][c][o][m][e]", groups_only=True)
...
@saka_cmd(pattern="[Dd][e][l][w][e][l][c][o][m][e]", groups_only=True)
...
@saka_cmd(pattern="[Gg][e][t][w][e][l][c][o][m][e]", groups_only=True)
...
@saka_cmd(pattern="[Ss][a][v][e][g][o][d]", groups_only=True)
...
@saka_cmd(pattern="[Dd][e][l][g][o][d]", groups_only=True)
...
@saka_cmd(pattern="[Gg][e][t][g][o][d]", groups_only=True)
