...
@saka_cmd(pattern="^[Cc][e][r][i][t][a][c][i][n][t][a]$")
async def _(event):
    animation_chars = [
        "`Cerita ❤️ Cinta` ",
        "  😐             😕 \n/👕\\         <👗\\ \n 👖               /|",
