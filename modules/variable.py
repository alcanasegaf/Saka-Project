...
@saka_cmd(pattern="[Ss][e][t][d][b]( (.*)|$)", fullsudo=False)
...
@saka_cmd(pattern=r"setvar (\S+)\s+(\S+)")
...
@saka_cmd(pattern="[Dd][e][l][d][b]( (.*)|$)", fullsudo=False)
...
@saka_cmd(pattern="[vV][a][r]($| (.*))", fullsudo=False)
