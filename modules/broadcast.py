...
from Saka.dB.gcast_blacklist_db import add_gblacklist, list_bl, rem_gblacklist
from telethon.errors.rpcerrorlist import FloodWaitError

from . import *


@saka_cmd(pattern="[gG][c][a][s][t]( (.*)|$)", fullsudo=False)
async def gcast(event):
    ...
    kk = await event.eor("`𝐒𝐚𝐤𝐚 𝐩𝐫𝐨𝐣𝐞𝐜𝐭 𝐩𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠 𝐦𝐚𝐬𝐬𝐚𝐠𝐞`")
    er = 0
    done = 0
    err = ""
...
@saka_cmd(pattern="[gG][u][c][a][s][t]( (.*)|$)", fullsudo=False)
