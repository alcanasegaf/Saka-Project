...
@saka_cmd(pattern="(grey|blur|negative|danger|mirror|quad|sketch|flip|toon)$")
async def saka_tools(event):
...
async def pixelator(event):
    ...
    await msg.respond("Pixelated by Saka", file="output.jpg")
    await msg.delete()
