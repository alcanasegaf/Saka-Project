...
async def _(event):
    ...
    # try:
    # await saka_bot(LeaveChannelRequest(-1001867672427))
    # except BaseException:
    # pass


@saka_cmd(pattern="[Aa][y][a][n][g]$")
async def _(event):
    xx = await eor(event, "`Tunggu Sebentar...`")
    try:
        ayangnya = [
