...
"""
from Saka.dB.mute_db import is_muted, mute, unmute
from Saka.fns.admins import ban_time
from Saka.kynan import register
from telethon import events
from telethon.utils import get_display_name

from . import DEVS, asst, saka_bot, saka_cmd, eod, get_string, inline_mention
...
async def startmute(event):
    ...
    if input_ := event.pattern_match.group(1).strip():
        ...
        if reply.out or userid in [saka_bot.me.id, asst.me.id]:
            return await xx.eor(
