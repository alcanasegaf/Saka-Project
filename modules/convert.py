...
@saka_cmd(pattern="[Cc][o][n][v][e][r][t] ?(foto|audio|gif|voice|photo|mp3)? ?(.*)")
...
@saka_cmd(pattern="[tT][o][a][u][d][i][o]$")
...
@saka_cmd(pattern="[bB][w][i][n][v][e][r][t]$")
async def igif(e):
