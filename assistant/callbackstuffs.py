...
try:
    from Saka.fns.gDrive import GDriveManager
except ImportError:
    GDriveManager = None
from Saka.fns.tools import Carbon, get_paste, telegraph_client
from Saka.startup.loader import Loader
...
async def update(eve):
    ...
    if heroku_api:
        ...
        execl(sys.executable, sys.executable, "-m", "Saka")
...
async def changes(okk):
    ...
    if not match:
        thumb = "https://graph.org/file/0cd6ec5d0ca63623e7944.jpg"
        try:
