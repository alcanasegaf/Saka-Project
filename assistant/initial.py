...
STRINGS = {
    1: """ **Terima Kasih Telah Deploy Saka-Userbot!**

Beberapa Bantuan Untuk Kamu Pelajari.""",
    2: """🎉** Tentang Saka-Userbot**

 Saka-Userbot adalah repo userbot yanh dibuat untuk kekasih saya, userbot ini memiliki beberapa fitur kamu bisa melihat nya dihalaman 4.
...
-> Kamu bisa membalas seseorang dari Saka-Userbot Logs ketika kamu di tag oleh seseorang digrup lain.
