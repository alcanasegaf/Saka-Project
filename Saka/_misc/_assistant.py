...
from .. import LOGS, asst, saka_bot, udB
from ..fns.admins import admin_check
from . import append_or_update, owner_and_sudos

OWNER = saka_bot.full_name

MSG = f"""
**Saka Userbot**
╼┅━━━━━━━━━━╍━━━━━━━━━━┅╾
**Owner**: [{OWNER}](tg://user?id={saka_bot.uid})
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/alcanasegaf/Saka-Userbot",
        ),
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(saka_bot.uid)
