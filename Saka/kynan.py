...
#
"""Userbot module for managing events. One of the main components of the usersaka_bot."""
...
from Saka import saka_bot
from Saka._misc._supporter import CMD_HNDLR, CMD_LIST
from Saka.dB import DEFAULT, DEVS
...
def command(**args):
    ...
    def decorator(func):
        ...
        if allow_edited_updates:
            saka_bot.add_event_handler(func, events.MessageEdited(**args))
        saka_bot.add_event_handler(func, events.NewMessage(**args))
    ...
    def decorator(func):
        ...
        if saka_bot:
            if not disable_edited:
                saka_bot.add_event_handler(wrapper, events.MessageEdited(**args))
            saka_bot.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
